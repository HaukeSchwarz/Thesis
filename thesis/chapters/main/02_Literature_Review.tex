...
%Fair modeling (preprocessing, in-processing, postprocessing - aequitas and ...)
...
In order to conclude this literature review, this section will evaluate how the the concepts of Fairness and Explainability are related to each other, showing that the analysis of each adds separate value in this thesis.
