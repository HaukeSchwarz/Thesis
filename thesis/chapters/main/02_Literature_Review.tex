...
%To-Do:
%Base on Zhou, Saleem and Molnar - quick list of most important terms (just short theoretical)
%   Feature importance vs. counterfactuals (does that fit here? - base on Zhou) / Partial Dependence
%   Add deeper dive into method used
%   Bild aus Saleem einfügen

This section will provide a brief overview of the different categories of Explainability algorithms. % !!! ... and provide some additional information on the method XXX, which will be used in this thesis. !!!
...
%XXX provides an extended overview of the categorizations mentioned above. 
