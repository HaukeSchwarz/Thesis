...
A crucial element in the Fairness discussion is the concepts of \textit{protected} or \textit{sensitive attributes}. These describe attributes that are legally protected from being the basis of potentially discriminatory decisions \parencite{Datta2017}.
...
Moreover, race is just one of the protected attributes present in the dataset analyzed in this thesis, meaning that other features present in the data can still be a source of unfairness, even though race might not be one of them.
...
%Maybe quote fair ML framework - relate to protected attributes from previous chapter
