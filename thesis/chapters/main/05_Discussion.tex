...
\textbf{Limitations} of the research conducted in this thesis can be found in the \textbf{data} used, the \textbf{models} applied, and the \textbf{fairness adjustments} conducted.
...
Other opportunities for future research might include the application of different fairness metrics, the inclusion of more data sources, or the analysis of the impact of different fairness adjustments on the performance of the models.