...
There are no missing values. The distribution of the target variable can be seen in \textbf{Figure \ref{fig:CHXX_Target_Variable_Distribution}}.
...
\begin{figure}[h]
    ...
    \caption{Correlation of the Target Variable with Categorical Features}
    \medskip
    \small
...
\begin{figure}[h]
    ...
    \caption{Correlation Between the Numerical Features}
    \medskip
    \small
