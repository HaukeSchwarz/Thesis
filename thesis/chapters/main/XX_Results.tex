...
Following the scope of this thesis specified in \textbf{chapter \ref{sec:Introduction}}, a special needs to be put focus on fairness, specifically equality with regards to the protected attribute(s).
...
XXX Update all when ready and add explanations - restructured! XXX
