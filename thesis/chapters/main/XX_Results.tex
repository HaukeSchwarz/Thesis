...
% Table with initial metrics (define and add in chapters of methodology - create standard table with e.g. ROC AUC, accuracy, precision, recall, F1 score, FPR Disparity, FNR Disparity, explain each value with literature and repeat for every iteration)
...
% Summary table with all iterations and "winner" selection?
