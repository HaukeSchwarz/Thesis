...
\begin{figure}[h]
    ...
    \caption{Methodology}
    \caption*{The procedure chosen for this thesis follows an iterative approach: After the initial model training and prediction, explainability, fairness, and performance are assessed. Based on these results, adjustments are made to the model and the data preparation process. The fairness of the model is then evaluated using the Aequitas framework. This process is repeated for multiple iterations, aiming to improve one or more of the criteria.}
...
From the original paper \parencite{2018aequitas}, the formulas for the calculation of the disparities can be inferred:
