...
Additionally, a common set of classification metrics, being \textbf{accuracy}, \textbf{precision}, \textbf{recall}, and \textbf{F1 score} (see \textbf{formula \ref{eq:Accuracy}} to \textbf{formula \ref{eq:F1}}), are calculated alongside the \textbf{confusion matrix}.
