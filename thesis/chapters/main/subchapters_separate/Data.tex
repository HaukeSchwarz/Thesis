...
\begin{figure}[h]
    ...
    \caption*{Visual Inspection of Missingness shows that some datapoints seem to be missing at random in \textit{interest\_rate}, \textit{loan\_to\_value\_ratio}, and \textit{debt\_to\_income\_ratio}, while the other features expose no or very little missingness.}
...
\begin{table}[h]
    ...
    \caption*{The summary statistics show that the data is complete and has a wide range of values.}
...
\begin{figure}[h]
    ...
    \caption*{Some of the enrichment features expectedly show a high correlation, examples being \textit{median\_household\_income} and \textit{poverty\_rate}.}
